    ...
    <section ref={ref} className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {/* Gemini Effect Integrated Title */}
            <div className="relative mb-8">
              <h1 className="text-6xl md:text-8xl font-light tracking-tight">
                <span className="block">Infrastructure</span>
                <span className="block italic font-serif bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
                  Simplified.
                </span>
              </h1>
              
              {/* Gemini Effect SVG Paths */}
              <svg
                width="1440"
                height="890"
                viewBox="0 0 1440 890"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute -top-60 md:-top-40 w-full left-1/2 -translate-x-1/2"
              >
                <motion.path
